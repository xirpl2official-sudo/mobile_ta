...
class FAQActivity : AppCompatActivity() {
    ...
    private val allFaqs = listOf(
        ...
        FAQItem("Siapa yang harus saya hubungi untuk bantuan teknis?", "Jika Anda mengalami kendala aplikasi, silakan hubungi layanan informasi resmi SMK Negeri 2 Singosari melalui kontak yang tercantum di bagian bawah halaman ini.")
    )
